  ...
  <div class="panel with-nav-tabs panel-success">
    <div class="panel-heading">
      <ul class="nav nav-tabs">
        <li class="active"><a href="#nowshowing" data-toggle="tab">Recommendations</a></li>
      </ul>
    </div>
                  ...
                  <div class='back'>
                    <div class='content'>
                      ...
                      <div style='margin-top: 4vw;' class='buy_ticket'>
                        <a <a href='javascript:void(0)' onclick='openLoginModal();' class='btn btn-primary btn-xs btn-block'>Click to get details</a>
                      </div>
                    </div>
                  </div> <!-- end card -->
